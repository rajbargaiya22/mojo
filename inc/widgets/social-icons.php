...
class RJ_Bookmarks_Social_Icons extends WP_Widget {
	...
	public function widget( $rj_bookmarks_args, $rj_bookmarks_instance ) { ?>
		<div class="widget12">
			...
			$rj_bookmarks_whatsapp = isset( $rj_bookmarks_instance['whatsapp'] ) ? $rj_bookmarks_instance['whatsapp'] : '';
			...
			if(!empty($rj_bookmarks_facebook) ){ ?>
					<a class="custom_facebook" href="<?php echo esc_url($rj_bookmarks_facebook); ?>" title="<?php echo esc_attr( 'Facebook','rj-mojo' );?>">
						<i class="fa-brands fa-facebook-f"></i>
					</a>
				<?php }
			if(!empty($rj_bookmarks_whatsapp) ){ ?>
				<a class="custom_whatsapp" href="https://wa.me/<?php echo esc_url($rj_bookmarks_whatsapp); ?>" title="<?php echo esc_attr( 'Whatsapp','rj-mojo' );?>">
					<i class="fa-brands fa-whatsapp"></i>
				</a>
			<?php }
			if(!empty($rj_bookmarks_twitter) ){ ?>
				<a class="custom_twitter" href="<?php echo esc_url($rj_bookmarks_twitter); ?>" title="<?php echo esc_attr( 'Twitter','rj-mojo' );?>">
					<i class="fab fa-twitter"></i>
				</a>
			<?php }
	        if(!empty($rj_bookmarks_linkedin) ){ ?>
						<a class="custom_linkedin" href="<?php echo esc_url($rj_bookmarks_linkedin); ?>" title="<?php echo esc_attr( 'Linkedin','rj-mojo' );?>">
							<i class="fab fa-linkedin-in"></i>
						</a>
					<?php }
	        if(!empty($rj_bookmarks_pinterest) ){ ?>
						<a class="custom_pinterest" href="<?php echo esc_url($rj_bookmarks_pinterest); ?>" title="<?php echo esc_attr( 'Pinterest','rj-mojo' );?>">
							<i class="fab fa-pinterest-p"></i>
						</a>
					<?php }
	        if(!empty($rj_bookmarks_tumblr) ){ ?>
						<a class="custom_tumblr" href="<?php echo esc_url($rj_bookmarks_tumblr); ?>"  title="<?php echo esc_attr( 'Tumblr','rj-mojo' );?>">
							<i class="fab fa-tumblr"></i>
						</a>
					<?php }
	        if(!empty($rj_bookmarks_instagram) ){ ?>
						<a class="custom_instagram" href="<?php echo esc_url($rj_bookmarks_instagram); ?>" title="<?php echo esc_attr( 'Instagram','rj-mojo' );?>">
							<i class="fab fa-instagram"></i>
						</a>
					<?php }
	        if(!empty($rj_bookmarks_youtube) ){ ?>
						<a class="custom_youtube" href="<?php echo esc_url($rj_bookmarks_youtube); ?>" title="<?php echo esc_attr( 'Youtube','rj-mojo' );?>">
	...
	public function form( $rj_bookmarks_instance ) {
		...
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('whatsapp')); ?>" name="<?php echo esc_attr($this->get_field_name('whatsapp')); ?>" type="text" value="<?php echo esc_attr($rj_bookmarks_facebook); ?>">
		</p>
		<p>
	...
	public function update( $rj_bookmarks_new_instance, $rj_bookmarks_old_instance ) {
		...
		$rj_bookmarks_instance['whatsapp'] = (!empty($rj_bookmarks_new_instance['whatsapp']) ) ? esc_url_raw($rj_bookmarks_new_instance['whatsapp']) : '';
