...
<section class=" py-3 py-lg-5">
  <h2 class="entry-title"><?php echo esc_html(get_theme_mod('rj_bookmarks_no_results_page_title',__('Nothing Found','rj-mojo')));?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php echo esc_html(get_theme_mod('rj_bookmarks_no_results_page_content',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','rj-mojo')));?></p>
